...
#             print(np.tan(1/(np.sin(np.pi/8))))
        ...
        for i in range(2):
            strikes[3+i*10].shift([0, strikes[2].get_end()[1]-strikes[3+10*i].get_end()[1]+5.5, 0])
            strikes[6+i*10].shift([0, strikes[2].get_end()[1]-strikes[6+10*i].get_end()[1]+5.5, 0])
            # shift lower layer of strikes 
            strikes[8+i*10].shift([0, strikes[7].get_start()[1]-strikes[8+10*i].get_start()[1]-5.5, 0])
            strikes[11+i*10].shift([0, strikes[7].get_start()[1]-strikes[11+10*i].get_start()[1]-5.5, 0])
        strikes[1].shift([0, strikes[2].get_end()[1]-strikes[1].get_end()[1]-5.5, 0])
        strikes[23].shift([0, strikes[7].get_end()[1]-strikes[23].get_end()[1]+5.5, 0])
