...
#############################################################################
def crop2topo(sol, dem_path, a=None):
    '''Crop gempy lith_block to land surface using an imported DEM raster file.
    
    Inputs:
    sol:      gempy solutions object containing lith_block and grid
    dem_path: path to DEM raster file of same xy dimensions as model, to be used for cropping
    a:        optional: other array to be cropped (e.g. as provided by mapping.crop2raster())
    ...
    #Get DEM from file & convert to topo array:
